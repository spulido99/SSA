...
public class LassoFitGenerator {
        ...
        public void init(double[] targets, double[][] obsrevations) {
        	this.observations = obsrevations;
        	this.targets = targets;
        	this.numObservations = obsrevations.length;
        	this.numFeatures = obsrevations[0].length;
        }
